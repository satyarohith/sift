...
[![deno doc](https://doc.deno.land/badge.svg)](https://doc.deno.land/https/deno.land/x/sift@0.4.1/mod.ts)

## Usage

The documentation below briefly explains the common usage of the functions. You
can visit [deno doc](https://doc.deno.land/https/deno.land/x/sift@0.4.1/mod.ts)
...
```js
import { json, serve } from "https://deno.land/x/sift@0.4.1/mod.ts";
...
```jsx
/** @jsx h */
import { h, jsx, serve } from "https://deno.land/x/sift@0.4.1/mod.ts";
