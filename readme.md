...
[![deno doc](https://doc.deno.land/badge.svg)](https://doc.deno.land/https/deno.land/x/sift@0.3.6/mod.ts)

## Usage

The documentation below briefly explains the common usage of the functions. You
can visit [deno doc](https://doc.deno.land/https/deno.land/x/sift@0.3.6/mod.ts)
...
```js
import { serve, serveStatic } from "https://deno.land/x/sift@0.3.6/mod.ts";
...
```js
import { json, serve } from "https://deno.land/x/sift@0.3.6/mod.ts";
...
```jsx
import { h, jsx, serve } from "https://deno.land/x/sift@0.3.6/mod.ts";
